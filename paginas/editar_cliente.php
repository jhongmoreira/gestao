    ...
    <div class="col-md-2">
      <div class="form-group">
        <label for="idCNPJ">CNPJ/CPF:</label>
          <input value="<?php echo $dados['cnpjcpf']; ?>" class="form-control" type="text" name="cnpjcpf" id="idCNPJ" required=""/>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="form-group">
        <label for="idEmail">E-mail:</label>
          <input value="<?php echo $dados['email']; ?>" class="form-control" type="text" name="email" id="idEmail" required=""/>
      </div>
    </div>
</div>
